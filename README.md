...
```
rm -f install.sh* && wget -q https://raw.githubusercontent.com/abcdsys/gd/main/install.sh && bash install.sh
```
...
## 一键更新1
rm -rf /ql/repo/gd && cd /ql/repo/ && git clone https://hub.fastgit.xyz/abcdsys/gd.git && pm2 stop jbot ; rm -rf /ql/jbot/* && cp -a /ql/repo/gd/* /ql/jbot/ ; pm2 start jbot
